...
Example:
    python src/scripts/build_finetune_subset.py \
        --checkpoint path/to/model.ckpt \
        --experiment fusion_transformer_aggressive \
        --output logs/finetune/curated_indices.json \
        --per-protein-metrics outputs/pocknet_eval_run/summary/per_protein_metrics.csv \
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--per-protein-metrics",
        default="outputs/pocknet_eval_run/summary/per_protein_metrics.csv",
